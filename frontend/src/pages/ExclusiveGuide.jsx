      ...
      <div className="max-w-6xl mx-auto p-6">
        ...
        <div className="mb-8">
          ...
          <p className={isDark ? 'text-gray-400' : 'text-gray-600'}>
            Expert resources to accelerate your job search and career growth
          </p>
        </div>
        ...
        <div className={`text-center py-16 rounded-2xl ${
          ...
          <p className={isDark ? 'text-gray-400' : 'text-gray-600'}>
            Guides will appear here when available.
          </p>
        </div>
      </div>
    </div>
